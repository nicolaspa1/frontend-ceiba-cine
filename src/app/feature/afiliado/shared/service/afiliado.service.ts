...
export class AfiliadoService {
  ...
  public consultar() {
    return this.http.doGet<Afiliado[]>(
      `${environment.endpoint}/afiliados`,
      this.http.optsName('consultar afiliados')
    );
  }

  public guardar(afiliado: Afiliado) {
    return this.http.doPost<Afiliado, boolean>(
      `${environment.endpoint}/afiliados`,
      afiliado,
  ...
  public actualizar(afiliado: Afiliado): Observable<void> {
    return this.http.doPut<Afiliado, void>(
      `${environment.endpoint}/afiliados/`,
      afiliado,
  ...
  public getAfiliado(id: string) {
    return this.http.doGet<Afiliado>(
      `${environment.endpoint}/afiliados/${id}`,
      this.http.optsName('buscar afiliados')
    );
  }
